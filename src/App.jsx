...
//         <h1 className='font-bold tracking-wide text-3xl'>WeatherForecast</h1>
...
//       <main className='w-full flex  gap-6 py-4 px-[10%] items-center justify-center'>
...
function App() {
  ...
  return (
    <div className="w-full h-screen text-black px-8">
      ...
      <div>
        {/* <h1 className='text-4xl font-bold'>Hourly Forecast</h1>
        <div className="hourlyForecastContainer flex justify-center gap-8 flex-wrap w-full">
          {hourlyForecast.map((hourlyData) => (
            <HourlyForecast
              key={hourlyData.datetime}
              time={hourlyData.datetime}
              temp={hourlyData.temp}
              iconString={hourlyData.conditions}
            />
          ))}
        </div> */}
